 ...
 * @See_also: #GtkBox
 *
 * GtkCSDTitleBar is similar to a horizontal #GtkBox, it allows to place
 ...
 * can be turned off with gtk_csd_title_bar_set_has_subtitle().
 *
 * GtkCSDTitleBar can add typical window frame controls, such as minimize,
                             ...
                             GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_DECORATION_LAYOUT:
      g_value_set_string (value, gtk_csd_title_bar_get_decoration_layout (bar));
      break;
                             ...
                             GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_DECORATION_LAYOUT:
      gtk_csd_title_bar_set_decoration_layout (bar, g_value_get_string (value));
      break;
...
gtk_csd_title_bar_class_init (GtkCSDTitleBarClass *class)
{
  ...
  /**
   * GtkCSDTitleBar:show-close-button:
   *
   * Whether to show window decorations.
   *
   * Which buttons are actually shown and where is determined
   * by the #GtkCSDTitleBar:decoration-layout property, and by
  ...
  /**
   * GtkCSDTitleBar:decoration-layout:
   * 
   * The decoration layout for buttons. If this property is
   * not set, the #GtkSettings:gtk-decoration-layout setting
   * is used.
   *
   * See gtk_csd_title_bar_set_decoration_layout() for information
  ...
  /**
   * GtkCSDTitleBar:decoration-layout-set:
   *
   * Set to %TRUE if #GtkCSDTitleBar:decoration-layout is set.
   *
   * Since: 3.12
   */
  g_object_class_install_property (object_class,
...
/**
 * gtk_csd_title_bar_set_decoration_layout:
 * @bar: a #GtkCSDTitleBar
 ...
 */
void
gtk_csd_title_bar_set_decoration_layout (GtkCSDTitleBar *bar,
                                      const gchar  *layout)
{
  GtkCSDTitleBarPrivate *priv;
...
/**
 * gtk_csd_title_bar_get_decoration_layout:
 * @bar: a #GtkCSDTitleBar
 *
 ...
 */
const gchar *
gtk_csd_title_bar_get_decoration_layout (GtkCSDTitleBar *bar)
{
  GtkCSDTitleBarPrivate *priv;
